...
import { GridBackground } from "@/src/components/base/HeroComponents/GridBackground";
...
export function Hero() {
    return (
        <section className="relative isolate bg-background overflow-hidden">
            <div className="relative mx-auto max-w-6xl px-6 pt-20 sm:pt-20 pb-20 text-center">
                <Announcement />
                <h1 className="mx-auto mt-8 max-w-3xl text-[44px] sm:text-[40px] leading-[1.04] font-medium tracking-[-0.025em] text-foreground">
