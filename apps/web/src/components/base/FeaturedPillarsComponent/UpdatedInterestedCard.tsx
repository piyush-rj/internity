...
export function UpdatedInterestsCard() {
    ...
    return (
        ...
        >
            ...
            {/* Bottom row */}
            <div className="grid grid-cols-3 flex-1 min-h-0 gap-0.75 mt-0.75">

                {/* Progress bar column */}
                <div className="col-span-1 relative rounded-xs overflow-hidden">
                    {/* Hatched background — the "unfilled" portion */}
                    <div
                    ...
                    />
                    {/* Number overlay */}
                    {/* <div className="relative z-10 h-full flex flex-col justify-end px-4 pb-5 gap-3">
                        <div className="h-9 rounded-full bg-neutral-900 flex items-center justify-center">
