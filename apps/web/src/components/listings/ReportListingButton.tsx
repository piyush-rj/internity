        ...
        <>
            <button
                ...
                className={cn(
                    ...
                    "text-[12.5px] text-muted-foreground hover:bg-secondary hover:text-foreground cursor-pointer",
                )}
            >
                ...
                <div className="px-5 py-4">
                    <label className="block space-y-1">
                        ...
                        <textarea
                            ...
                            placeholder="Spam, fake company, asks for money, unsafe role, misleading description…"
                            className={cn(
