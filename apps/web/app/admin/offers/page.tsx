        ...
        <section className="px-3 sm:px-6 py-4 sm:py-6 space-y-5">
            <header className="space-y-1">
                ...
                <p className="text-[12.5px] text-muted-foreground">
                    Create and manage promotional offers and discount coupon
                    codes.
                </p>
            </header>
...
function CouponPanel({
    ...
    const rows: {
        ...
        {
            label: "Created by",
            value: `${c.createdBy.name ?? "—"} (${c.createdBy.email ?? "—"})`,
        },
        ...
        ...(c.revokedAt
            ? [
                  ...
                  {
                      label: "Revoked at",
                      value: formatDateFull(c.revokedAt),
                      colored: "text-rose-500",
                  },
              ]
            : []),
        ...
        <>
            ...
            >
                ...
                <div className="px-5 py-6 border-b border-border text-center bg-secondary/30 shrink-0">
                    <p className="font-mono text-[28px] font-bold tracking-widest">
                        {c.code}
                    </p>
                    <p className="mt-1 text-[13px] text-orange-600 font-semibold">
                        {c.discountPctPerPost === c.discountPctMonthly &&
                        c.discountPctMonthly === c.discountPctYearly
...
function OfferPanel({
    ...
    const rows: { label: string; value: string; colored?: string }[] = [
        ...
        {
            label: "Created by",
            value: `${o.createdBy.name ?? "—"} (${o.createdBy.email ?? "—"})`,
        },
        ...
        ...(o.revokedAt
            ? [
                  ...
                  {
                      label: "Revoked at",
                      value: formatDateFull(o.revokedAt),
                      colored: "text-rose-500",
                  },
              ]
            : []),
    ...
    return createPortal(
        <>
            ...
            >
                ...
                {/* Hero */}
                <div className="px-5 py-6 border-b border-border text-center bg-secondary/30 shrink-0">
                    <p className="text-[20px] font-bold leading-snug px-2">
                        {o.title}
                    </p>
                    <p className="mt-1 text-[13px] text-orange-600 font-semibold">
                        {o.discountPctPerPost === o.discountPctMonthly &&
                        o.discountPctMonthly === o.discountPctYearly
                ...
                <div className="flex-1 overflow-y-auto px-5 py-4">
                    {rows.map((row) => (
                        ...
                        >
                            ...
                            <span
                                className={cn(
                                    "text-[12px] font-medium text-right break-words max-w-[55%]",
                                    row.colored,
                                )}
                            >
                                {row.value}
        ...
        >
            <div>
                ...
                <p className="text-[12px] text-muted-foreground mt-0.5">
                    Auto-appears on the pricing page for all users — no code
                    needed.
                </p>
            </div>
    ...
    return (
        ...
        >
            <div>
                ...
                <p className="text-[12px] text-muted-foreground mt-0.5">
                    Single-use per user — entered at checkout to apply the
                    discount.
                </p>
            </div>
            ...
            <div className="space-y-1">
                ...
                <input
                    ...
                    className={`${fieldCls} max-w-xs font-mono tracking-wide`}
                    required
                />
            </div>
    ...
    return (
        <div className="divide-y divide-border">
            {Array.from({ length: 4 }).map((_, i) => (
                <div
                    key={i}
                    className="px-4 sm:px-5 py-3.5 flex items-center gap-3 animate-pulse"
                >
